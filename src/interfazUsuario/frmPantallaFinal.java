 ...
 * @author Oscar
 */
public class frmPantallaFinal extends javax.swing.JFrame {
     ...
     */
    public frmPantallaFinal(String nombre, String puntuacion) {
        initComponents();
        this.nombre = nombre;
        ...
        control.leeJugadoresArchivo();
        control.agregaJugador(jugador);
        List<Jugador> nuevaLista = control.ordenaJugadoresManual();
        control.escribeJugadoresPerrones(nuevaLista);
